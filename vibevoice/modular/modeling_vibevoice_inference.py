...
class VibeVoiceForConditionalGenerationInference(
    VibeVoicePreTrainedModel, GenerationMixin
):
    ...
    def generate(
        ...
        **kwargs,
        ...
        token_constraint_processor = VibeVoiceTokenConstraintProcessor(
...
AutoModelForCausalLM.register(
    VibeVoiceConfig, VibeVoiceForConditionalGenerationInference
)
